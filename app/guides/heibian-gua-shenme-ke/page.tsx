...
export const metadata: Metadata = {
  title: "黑便挂什么科",
  description: "黑便可能提示消化道出血，一般优先看消化内科或急诊科；若伴头晕乏力应尽快就医检查。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/heibian-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "黑便通常需要优先考虑消化内科或急诊科。黑便可能提示上消化道出血，如胃溃疡或胃炎。如果伴头晕、乏力或心慌，应尽快前往医院检查。";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/heibian-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">黑便挂什么科</h1>
