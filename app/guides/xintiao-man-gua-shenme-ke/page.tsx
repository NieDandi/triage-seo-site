...
export const metadata: Metadata = {
  title: "心跳慢挂什么科",
  description: "心跳慢一般优先看心内科，部分人群可能属于正常现象；若伴头晕或乏力应尽快检查。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/xintiao-man-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "心跳慢一般优先考虑心内科。部分人群在运动或睡眠状态下心率较低属于正常现象。但若伴头晕、乏力或晕厥，建议及时进行心电图检查。";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/xintiao-man-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">心跳慢挂什么科</h1>
