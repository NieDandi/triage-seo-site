...
export const metadata: Metadata = {
  title: "记忆力下降挂什么科",
  description: "记忆力下降一般优先看神经内科，可能与压力、睡眠不足或神经系统问题有关；若持续加重应尽早评估。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/jiyili-xiajiang-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "S记忆力下降一般优先考虑神经内科。可能与压力、睡眠不足、焦虑或神经系统问题有关。若症状逐渐加重或影响日常生活，建议尽早进行专业评估。UMMARY_PLACEHOLDER";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/jiyili-xiajiang-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">记忆力下降挂什么科</h1>
