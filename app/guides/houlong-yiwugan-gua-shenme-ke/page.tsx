...
export const metadata: Metadata = {
  title: "喉咙有异物感挂什么科",
  description: "喉咙有异物感一般优先看耳鼻喉科，可能与咽炎或胃食管反流有关；若伴吞咽困难或持续疼痛应尽快检查。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/houlong-yiwugan-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "喉咙有异物感一般优先看耳鼻喉科。常见原因包括咽炎、胃食管反流或情绪紧张等。如果伴吞咽困难、持续疼痛或明显声音变化，应尽快就医进一步检查。";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/houlong-yiwugan-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">喉咙有异物感挂什么科</h1>
