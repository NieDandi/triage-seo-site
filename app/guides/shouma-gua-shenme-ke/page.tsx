...
export const metadata: Metadata = {
  title: "手麻挂什么科",
  description: "手麻一般优先看神经内科，可能与颈椎问题或神经受压有关；若伴肢体无力应尽快就医。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/shouma-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "手麻通常优先考虑神经内科。常见原因包括颈椎问题、神经受压或血液循环问题。若伴肢体无力、言语困难或突然出现症状，应尽快就医排查急性问题。";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/shouma-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">手麻挂什么科</h1>
