...
export const metadata: Metadata = {
  title: "胃酸过多挂什么科",
  description: "胃酸过多一般优先看消化内科，常见于胃食管反流或胃炎；若伴吞咽困难或持续烧心，应进一步检查。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/weisuan-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "胃酸过多一般优先考虑消化内科。常见表现包括反酸、烧心或胃部不适，可能与胃炎或胃食管反流有关。若症状持续时间较长或伴吞咽困难，应进一步检查。";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/weisuan-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">胃酸过多挂什么科</h1>
