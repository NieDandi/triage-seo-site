...
export const metadata: Metadata = {
  title: "打喷嚏挂什么科",
  description: "频繁打喷嚏一般优先看耳鼻喉科，常见于过敏性鼻炎或感冒；若伴鼻塞、流鼻涕或长期反复，应进一步评估。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/dapenqi-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "频繁打喷嚏通常优先考虑耳鼻喉科。若伴鼻痒、流清鼻涕，常见于过敏性鼻炎；如果伴鼻塞、喉咙痛或发热，也可能是感冒或上呼吸道感染。症状反复出现时建议进行过敏评估。";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/dapenqi-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">打喷嚏挂什么科</h1>
