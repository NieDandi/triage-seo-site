...
export const metadata: Metadata = {
  title: "便秘挂什么科",
  description: "便秘一般优先看消化内科，常见于饮食结构或肠道功能问题；若伴便血或长期持续，应尽快检查。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/bianmi-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "便秘通常优先考虑消化内科。常见原因包括饮食纤维不足、饮水不足或肠道功能问题。若伴腹痛、便血、体重下降或长期持续，建议尽快进行肠道相关检查。";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/bianmi-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">便秘挂什么科</h1>
