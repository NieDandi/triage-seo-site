...
export const metadata: Metadata = {
  title: "恶心想吐挂什么科",
  description: "恶心想吐一般优先看消化内科，常见于胃炎或食物中毒；若伴剧烈头痛或持续呕吐，应尽快就医。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/exin-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "恶心想吐一般优先考虑消化内科。常见原因包括胃炎、食物中毒或消化不良。如果伴头晕、剧烈头痛或持续呕吐，也可能涉及神经系统问题。若出现脱水或无法进食，应尽快就医。";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/exin-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">恶心想吐挂什么科</h1>
