...
export const metadata: Metadata = {
  title: "头皮发麻挂什么科",
  description: "头皮发麻一般优先看神经内科，可能与神经紧张或颈椎问题有关；若伴头晕或肢体麻木应尽快检查。",
  alternates: {
    canonical: "https://triage-seo-site.vercel.app/guides/toupifama-gua-shenme-ke",
  },
};
...
export default function GuidePage() {
  ...
  const aiSummary =
    "SUMMA头皮发麻通常优先考虑神经内科。常见原因包括神经紧张、颈椎问题或神经受压。如果伴头晕、视力变化或肢体麻木，建议及时就医检查。RY_PLACEHOLDER";
  ...
  const webPageJsonLd = {
    ...
    url: "https://triage-seo-site.vercel.app/guides/toupifama-gua-shenme-ke",
  };
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl p-6 space-y-6">
        ...
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold">头皮发麻挂什么科</h1>
